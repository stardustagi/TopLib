...
// this is that NatsConnection implementation of NATS brings the burden of
// additional struct fields which are not used by Publisher. NatsConnection
// is not implemented separately because PubSub can be used where NatsConnection is needed.
package nats
